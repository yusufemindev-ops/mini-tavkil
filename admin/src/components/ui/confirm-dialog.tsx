...
// destructive or irreversible actions (delete, suspend, …).
//
// <ConfirmDialog
//   trigger={<Button variant="destructive">Delete account</Button>}
//   title="Delete this account?"
//   description="This permanently removes the buyer. This cannot be undone."
...
export function ConfirmDialog({
  ...
  /** Controlled open state — use when opening the dialog programmatically (e.g. from a menu). */
  open?: boolean;
    ...
    <AlertDialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <AlertDialog.Portal>
        ...
        >
          ...
          {description && (
            <AlertDialog.Description className="text-muted-foreground mt-1 text-[13px]">
              {description}
